        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p>
              ...
              веб-сайта{" "}
              <a href="https://gamestate-monitor.ru">
          ...
          <section className={styles.section}>
            ...
            <h4>
              Цель 1: Информирование Пользователя посредством отправки
              электронных писем
            </h4>
            <p>
              <strong>Обрабатываемые данные:</strong> электронный адрес, имя.
            </p>
            <p>
              <strong>Виды обработки:</strong> Сбор, запись, систематизация,
            ...
            <h4>
              Цель 2: Предоставление доступа Пользователю к сервисам, информации
              и/или материалам, содержащимся на веб-сайте
            </h4>
            <p>
              <strong>Обрабатываемые данные:</strong> электронный адрес,
              фотографии, имя, логин пользователя. Также возможен сбор и
              обработка обезличенных данных о посетителях (файлы «cookie», HTTP
              заголовки, данные о технических характеристиках устройства
              (разрешении экрана, операционной системе и типе устройства),
              веб-браузере пользователя (типе и версии WEB браузера) и языке,
              IP-адрес, идентификатор сессии, информация об аппаратном и
              программном обеспечении, идентификатор пользователя (user ID),
              данные о сторонних сайтах (реферерах), с которых были совершены
              переходы, поисковые запросы, дата и время осуществления доступа к
              сайту, информацию об активности на сайте, обращения в службу
              поддержки сайта, теги JavaScript и веб-маяки (включая пиксельные
              теги), в том числе и сторонними сервисами интернет-статистики
              (например, Яндекс.Метрика, LiveInternet, РСЯ).
            </p>
            <p>
              <strong>Виды обработки:</strong> Сбор, запись, систематизация,
              накопление, хранение, уничтожение и обезличивание персональных
          ...
          <section className={styles.section}>
            ...
            <p>
              ...
              Оператора{" "}
              <a href="mailto:privacy@gamestate-monitor.ru">
                privacy@gamestate-monitor.ru
              </a>{" "}
          ...
          <section className={styles.section}>
            ...
            <p>
              ...
              <a href="https://gamestate-monitor.ru/policy">
                https://gamestate-monitor.ru/policy
              </a>
              .
            </p>
          </section>
